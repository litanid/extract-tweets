...
这个文件还需要修改，针对老文件如2017_07.js中的视频就无法下载下来，2017_08.js文件
一半是老格式，一半是新格式。
下载视频内容部分代码得要更改，不能用urlretrieve(),不保险
...
instrp = '%Y-%m-%d %H:%M:%S +0000'		#对应  2017-12-31 15:15:15 +0000
#instrp = '%a %b %d %H:%M:%S +0000 %Y'	#对应  Wed Nov 29 15:37:26 +0000 2017
'''
		存档推文日期时间格式，根据实际修改：
			...
			try:
				if tweet['entities']['media']:
					...
					for media in tweet['entities']['media']:
						if '/photo/' in media['expanded_url']:
						...
						elif '/video/' in media['expanded_url'] :
							...
							try:
								...
								print("<br />[videos href='{0}']{1}[/videos]".format(local_media_video_filename,local_media_image_filename),file = outputFile)
								tweet_video_count = tweet_video_count + 1
								tweet_video_total_count = tweet_video_total_count + 1
								print("\t*********第{0}个视频（{1}）下载成功！！".format(tweet_video_count,better_media_video_url_https))
